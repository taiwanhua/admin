...
export const P = styled.p.attrs((props) => ({
    ...
    @media ${mediaQuery.tablet} { 
        ...
        background-color: ${props => props?.theme?.tablet?.backgroundColor ? props.theme.tablet.backgroundColor : (props?.theme?.backgroundColor ?? 'unset')};
        ...
        width: ${props => props?.theme?.tablet?.width ? props.theme.tablet.width : (props?.theme?.width ?? 'unset')};
        font-family: ${props => props?.theme?.tablet?.fontFamily ? props.theme.tablet.fontFamily : (props?.theme?.fontFamily ?? 'Impact')};
        padding: ${props => props?.theme?.tablet?.padding ? props.theme.tablet.padding : (props?.theme?.padding ?? 'unset')};
        transition: background-color 1s ease, color 1s ease;
...
export const H6 = styled.h6.attrs((props) => ({
    ...
    // //常用屬性
    display: ${props => props?.theme?.display ?? 'unset'};
    ...
    transition: background-color 1s ease, color 1s ease;
    text-align: ${props => props?.theme?.textAlign ?? 'center'}; 
    border-right: ${props => props?.theme?.borderRight ?? 'unset'}; 
    ...
    @media ${mediaQuery.tablet} { 
        ...
        display: ${props => props?.theme?.tablet?.display ? props.theme.tablet.display : (props?.theme?.display ?? 'unset')};
        ...
        color: ${props => props?.theme?.tablet?.color ? props.theme.tablet.color : (props?.theme?.color ?? 'unset')};
        background-color: ${props => props?.theme?.tablet?.backgroundColor ? props.theme.tablet.backgroundColor : (props?.theme?.backgroundColor ?? 'unset')};
        line-height: ${props => props?.theme?.tablet?.height ? props.theme.tablet.height : (props?.theme?.height ?? '1.6')};
        height: ${props => props?.theme?.tablet?.height ? props.theme.tablet.height : (props?.theme?.height ?? 'unset')};
        width: ${props => props?.theme?.tablet?.width ? props.theme.tablet.width : (props?.theme?.width ?? 'unset')};
        padding: ${props => props?.theme?.tablet?.padding ? props.theme.tablet.padding : (props?.theme?.padding ?? 'unset')};
        transition: background-color 1s ease, color 1s ease;
        text-align: ${props => props?.theme?.tablet?.textAlign ? props.theme.tablet.textAlign : (props?.theme?.textAlign ?? 'center')};
        ...
        cursor: ${props => props?.theme?.tablet?.cursor ? props.theme.tablet.cursor : (props?.theme?.cursor ?? '#$@')};
    }
